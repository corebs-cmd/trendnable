...
async function classifyWithClaude(
  ...
  const FANDOMS = 'pokemon (Pokémon franchise — cards, figures, plush, merchandise), starwars (Star Wars franchise), marvel (Marvel Comics / MCU — Spider-Man, Iron Man, Captain America, X-Men, etc.), dc (DC Comics — Batman, Superman, Wonder Woman, Joker, Justice League, etc.), anime (ALL anime and manga franchises: One Piece, Demon Slayer, Naruto, Dragon Ball/DBZ, Attack on Titan, Bleach, Jujutsu Kaisen, My Hero Academia, and any other anime — this is the broadest bucket), sports (sports memorabilia, athlete figures, signed sports items, stadium exclusives, sports trading cards — NOT Pokémon cards), videogames (video game characters and IP: Nintendo/Mario/Zelda/Splatoon, PlayStation/Xbox exclusives, Halo, Call of Duty, Sonic, Minecraft — do NOT use for Pokémon, use pokemon instead), nostalgia (retro and vintage collectibles: 80s/90s pop culture, classic horror — Ghostbusters, Stranger Things, Terminator, Alien, Halloween, Friday the 13th, TMNT, classic TV/film, Hot Wheels castings, Labubu/designer toys without a specific fandom)';
